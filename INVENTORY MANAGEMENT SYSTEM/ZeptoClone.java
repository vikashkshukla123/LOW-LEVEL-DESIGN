...
class ZeptoHelper {
    ...
    public static void initialize() {
        ...
        // darkstore a...
        DarkStore darkStoreA = new DarkStore("DarkSotreA", 0, 0);
...
public class ZeptoClone {
    public static void main(String[] args) {
        ...
        System.out.println("Thankyou for shopping with zepto");
