            ...
            if (rules.isValidMove(currentPos, diceValue, board.getBoardSize())) {
                ...
                if (entity != null) {
                    ...
                    if (isSnake) {
                        ...
                        notify(currentPlayer.getName() + " encountered snake at " + intermediatePos
                                + " now going down to " + newPos);
                    } else {
                        System.out.println("Great! Ladder at " + intermediatePos + "! Going up to " + newPos);
                        notify(currentPlayer.getName() + " encountered ladder at " + intermediatePos
                                + " now going up to " + newPos);
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        if (choice == 1) {
            ...
            if (customChoice == 1) {
                ...
                CustomCountBoardSetupStrategy strategy = new CustomCountBoardSetupStrategy(numSnakes, numLadders,
                        false);
